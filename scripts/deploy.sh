...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-env-vars=STORAGE_LOCATION=/storage/$SERVICE_NAME-data,OPENAI_API_KEY_ACCESS=api.openai.com,GEMINI_API_KEY_ACCESS=generativelanguage.googleapis.com,ANTHROPIC_API_KEY_ACCESS=api.anthropic.com,SERPER_API_KEY_ACCESS=google.serper.dev \
